...
# ------------------------------------------------------------------------------------------------ #
# Created    : Monday October 24th 2022 01:45:18 pm                                                #
# Modified   : Monday October 24th 2022 01:50:58 pm                                                #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
# Copyright  : (c) 2022 John James                                                                 #
# ================================================================================================ #
"""Learning Rate Configuration Definition Module
...
from csv.config.base import Config

# ------------------------------------------------------------------------------------------------ #


@dataclass
class ConstantLrConfig(Config):
...
@dataclass
class ExponentialLrConfig(Config):
...
@dataclass
class PolynomialLrConfig(Config):
...
@dataclass
class DirectPowerLrConfig(Config):
...
@dataclass
class PowerAndLinearDecayLrConfig(Config):
    """Configuration for DirectPower learning rate decay.
...
@dataclass
class PowerDecayWithOffsetLrConfig(Config):
...
@dataclass
class StepCosineLrConfig(Config):
    """Configuration for stepwise learning rate decay.
...
@dataclass
class LinearWarmupConfig(Config):
...
@dataclass
class PolynomialWarmupConfig(Config):
    """Configuration for linear warmup schedule config.
